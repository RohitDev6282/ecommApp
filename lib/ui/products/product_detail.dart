...
class ProdectDetatil extends StatefulWidget {
  const ProdectDetatil({Key? key}) : super(key: key);

  @override
  _ProdectDetatilState createState() => _ProdectDetatilState();
}

class _ProdectDetatilState extends State<ProdectDetatil> {
          ...
          child: Padding(
              ...
              child: Container(
                  ...
                  child: Stack(children: <Widget>[
                    ...
                    Padding(
                      padding: const EdgeInsets.fromLTRB(150, 310, 0, 100),
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: CircleAvatar(
                            ...
                            child: IconButton(
                              ...
                              color:
                                  _alreadySaved ? kPrimaryColor : kPrimaryColor,
                            ),
                          ),
                        ),
                      ),
